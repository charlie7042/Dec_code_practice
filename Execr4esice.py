...
searchlist= ["p_name","brand","Category"]                 #products[0].keys()
...
##        count=products[i]['p_name'].count(toSearch)
##        if count>0:
##            print(f"Product Name :{products[i]['p_name']}\nBrand Name : {products[i]['brand']}\nPrice : {products[i]['price']}")
##            break
##        count=products[i]['brand'].count(toSearch)
##        if count>0:
##            print(f"Product Name :{products[i]['p_name']}\nBrand Name : {products[i]['brand']}\nPrice : {products[i]['price']}")
##            break
##        count=products[i]['Category'].count(toSearch)
##        if count>0:
##            print(f"Product Name :{products[i]['p_name']}\nBrand Name : {products[i]['brand']}\nPrice : {products[i]['price']}")
##            break
##        
